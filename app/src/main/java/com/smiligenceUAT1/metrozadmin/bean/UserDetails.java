...
public class UserDetails {
    ...
    List<CategoryDetailsNew> categoryList=new ArrayList<> (  );
    ...
    public List<CategoryDetailsNew> getCategoryList() {
        return categoryList;
    }

    public void setCategoryList(List<CategoryDetailsNew> categoryList) {
