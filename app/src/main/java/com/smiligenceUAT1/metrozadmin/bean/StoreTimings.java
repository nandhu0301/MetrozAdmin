...
public class StoreTimings
{
    ...
    String sellerId;
    String storeStatus;
    String storeLiveUpdate;
    String reasonForSuspend;

    public String getReasonForSuspend() {
        return reasonForSuspend;
    }

    public void setReasonForSuspend(String reasonForSuspend) {
        this.reasonForSuspend = reasonForSuspend;
    }

    public String getStoreLiveUpdate() {
        return storeLiveUpdate;
    }

    public void setStoreLiveUpdate(String storeLiveUpdate) {
        this.storeLiveUpdate = storeLiveUpdate;
    }
