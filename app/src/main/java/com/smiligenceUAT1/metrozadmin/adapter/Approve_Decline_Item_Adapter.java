            ...
            if (!((Activity) mcontext).isFinishing ()) {
                ...
                new SweetAlertDialog ( mcontext, SweetAlertDialog.SUCCESS_TYPE )
                        ...
                        .setConfirmClickListener (sDialog -> {
                            DatabaseReference approvedDbref = FirebaseDatabase.getInstance("https://testmetrozproject-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("ProductDetails").child(String.valueOf(sellerDetailsList.get(position).getItemId()));
