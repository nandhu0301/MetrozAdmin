...
public class SellerWeeklySettlemetAdapter extends BaseAdapter  {
    ...
    public SellerWeeklySettlemetAdapter(Context context, List<PaymentDetails> itemListŇew, String paymentType1, int Percentage1) {
        mcontext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        SellerWeeklySettlemetAdapter.ViewHolder holder = new SellerWeeklySettlemetAdapter.ViewHolder();
        if (row == null) {
            LayoutInflater inflater = (LayoutInflater) mcontext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            row = inflater.inflate(R.layout.seller_paymentdetails_card, parent, false);
            ...
            holder = (SellerWeeklySettlemetAdapter.ViewHolder) row.getTag();
        }
