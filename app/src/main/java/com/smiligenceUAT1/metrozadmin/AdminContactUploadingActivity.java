...
import com.smiligenceUAT1.metrozadmin.bean.ContactDetails;
...
import static com.smiligenceUAT1.metrozadmin.common.Constant.METROZ_STORE_TIMINGS;
...
import static com.smiligenceUAT1.metrozadmin.common.Constant.TITILE_ADMIN_CONTACT_DETAILS;
...
public class AdminContactUploadingActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    DatabaseReference contactDetailsRef,userDetailsDataRef;
    ...
    DatabaseReference storeTimingMaintenanceDataRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactDetailsRef= FirebaseDatabase.getInstance("https://testmetrozproject-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("constant");
        ...
        storeTimingMaintenanceDataRef = FirebaseDatabase.getInstance ("https://testmetrozproject-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference ( METROZ_STORE_TIMINGS );

        navigationView.setNavigationItemSelectedListener(AdminContactUploadingActivity.this);
        navigationView.setCheckedItem(R.id.uploadcontactdetails);
            ...
            public void onClick(View v)
            {
                ...
                }else
                {
                    DatabaseReference startTimeDataRef = FirebaseDatabase.getInstance ("https://testmetrozproject-default-rtdb.asia-southeast1.firebasedatabase.app/")
                            .getReference ( METROZ_STORE_TIMINGS );
                    ...
                    startTimeDataRef.child("createdDate").setValue(  DateUtils.fetchCurrentDateTime());
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(AdminContactUploadingActivity.this, DashBoardActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
    }
