...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productKeyArrayList.add ( "Metroz@123" );
        businessNameArrayList.add ( "MetrozSupermarket" );


        loginUserDetails = FirebaseDatabase.getInstance ("https://testmetrozproject-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference ( USER_DETAILS_TABLE );
