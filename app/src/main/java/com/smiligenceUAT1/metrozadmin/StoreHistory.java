...
import com.smiligenceUAT1.metrozadmin.adapter.StoreListingAdapter;
...
public class StoreHistory extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sellerDetailsDataRef = FirebaseDatabase.getInstance("https://testmetrozproject-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("SellerLoginDetails");
        ...
        sellerDetailsDataRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                receiptAdapter = new StoreListingAdapter(StoreHistory.this, header_list,
                        (HashMap<String, List<UserDetails>>) expandableBillDetail);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(StoreHistory.this, DashBoardActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
    }
